import { P as reactExports, H as jsxRuntimeExports } from "./server-DzVaOEge.mjs";
import { j as useStore, W as Wallet, L as Link, e as createLucideIcon, t as topUpWallet, w as withdrawWallet, u as updateEscrowStatus } from "./router-DJW8gmps.mjs";
...
function TransactionsPage() {
  ...
  const [animateBalance, setAnimateBalance] = reactExports.useState(false);
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-zinc-950/5 bg-zinc-900 p-6 text-white shadow-lg relative overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: `font-display text-4xl font-medium mt-2 transition-all duration-300 ${animateBalance ? "animate-balance-glow text-brand" : ""}`, children: [
                "₦",
            ...
            currentUser.role === "buyer" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
                setShowTopUp(true);
                setShowWithdraw(false);
              }, className: "flex items-center justify-center gap-1 rounded-lg bg-brand px-4 py-2.5 text-xs font-semibold text-white transition-all hover:bg-brand/90 hover:scale-[1.02] active:scale-95 duration-200 shadow-sm", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
                ...
                setShowTopUp(false);
              }, className: "flex items-center justify-center gap-1 rounded-lg bg-zinc-800 px-4 py-2.5 text-xs font-semibold text-zinc-200 transition-all hover:bg-zinc-700 hover:scale-[1.02] active:scale-95 duration-200 shadow-sm", children: [
