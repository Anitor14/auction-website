...
import { R as Route$3, j as useStore, L as Link, e as createLucideIcon, p as placeBid, c as buyDutchAuction, b as addToCart } from "./router-DJW8gmps.mjs";
import { C as CountdownTimer } from "./countdown-C_KeH1Hw.mjs";
...
import { a as Truck, G as Gavel, T as TrendingUp } from "./truck-CsZKXs-7.mjs";
import { S as ShoppingBag } from "./shopping-bag-D9cpI2uJ.mjs";
import { L as Lock } from "./lock-DSGfl35_.mjs";
import { P as Plus, H as History } from "./plus--gXrf6gg.mjs";
...
function AuctionDetailPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-surface py-12 animate-fade-in-up", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-12 lg:grid-cols-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-5 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-zinc-950/5 bg-white p-6 shadow-sm", children: [
          ...
          product.status === "active" ? currentUser ? currentUser.role === "buyer" ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            product.type === "English" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handlePlaceBid, className: "space-y-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "submit", className: "group w-full flex items-center justify-center gap-2 rounded-lg bg-zinc-900 py-3 text-sm font-semibold text-white transition-all hover:bg-zinc-800 active:scale-[0.98] shadow", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Gavel, { className: "size-4 group-hover:animate-gavel-strike" }),
                " Place Ascending Bid"
              ] })
            ] }),
            ...
            product.type === "Sealed Bid" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handlePlaceBid, className: "space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group rounded-lg bg-zinc-50 border border-zinc-200/50 p-3 flex gap-2 hover:bg-zinc-100/50 transition-colors", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "size-4 text-blue-600 shrink-0 mt-0.5 group-hover:animate-lock-wobble" }),
            ...
            product.type === "Reverse" && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handlePlaceBid, className: "space-y-4", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { type: "submit", className: "group w-full flex items-center justify-center gap-2 rounded-lg bg-zinc-900 py-3 text-sm font-semibold text-white transition-all hover:bg-zinc-800 active:scale-[0.98]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Gavel, { className: "size-4 group-hover:animate-gavel-strike" }),
                " Submit Lower Offer"
              ] })
            ] }),
        ...
        product.type !== "Buy Now" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-zinc-950/5 bg-white p-6 shadow-sm", children: [
          ...
          ] }) : lotBids.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-8 text-center text-zinc-400 text-xs", children: "No offers placed yet. Be the first to place a bid!" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3 max-h-60 overflow-y-auto pr-1", children: lotBids.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center justify-between p-3 rounded-lg border text-xs transition-all animate-fade-in-up ${i === 0 ? "bg-brand/5 border-brand/20 animate-pulse-bid" : "bg-zinc-50 border-zinc-100"}`, children: [
