...
const appCss = "/assets/styles-mstFLmh6.css";
...
function RootComponent() {
  ...
  const router2 = useRouter();
  const [animateCart, setAnimateCart] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-surface font-sans text-ink selection:bg-brand/10 selection:text-brand flex flex-col", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "sticky top-0 z-50 border-b border-zinc-950/5 bg-surface/80 backdrop-blur-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto flex max-w-7xl items-center justify-between px-6 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "font-display text-2xl font-semibold tracking-tighter text-ink hover:text-brand transition-all hover:scale-102 active:scale-98 duration-200", children: "KILIMANJARO" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden items-center gap-6 sm:flex", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/products", className: "text-sm font-medium text-zinc-500 transition-colors hover:text-brand hover:scale-102 transition-transform active:scale-98 duration-150", children: "Browse Catalog" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/#how", className: "text-sm font-medium text-zinc-500 transition-colors hover:text-brand hover:scale-102 transition-transform active:scale-98 duration-150", children: "How It Works" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "/#pricing", className: "text-sm font-medium text-zinc-500 transition-colors hover:text-brand hover:scale-102 transition-transform active:scale-98 duration-150", children: "Pricing" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-4", children: currentUser ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        currentUser.role === "admin" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutDashboard, { className: "size-3.5 animate-pulse-bid" }),
              "Admin Panel"
            ]
          }
        ),
        currentUser.role === "buyer" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "size-3.5 text-brand transition-transform hover:rotate-12 duration-200" }),
        ...
        currentUser.role === "buyer" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            to: "/cart",
            className: `relative flex size-9 items-center justify-center rounded-full border border-zinc-950/10 bg-white text-zinc-700 shadow-sm transition-all hover:bg-zinc-50 hover:scale-105 active:scale-90 duration-200 ${animateCart ? "animate-cart-bounce" : ""}`,
            children: [
...
const $$splitComponentImporter$9 = () => import("./transactions-Bw944VXr.mjs");
...
const $$splitComponentImporter$8 = () => import("./products-C8wVTFPw.mjs");
const Route$8 = createFileRoute("/products")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./cart-BqK-IVqk.mjs");
const Route$7 = createFileRoute("/cart")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./index-ZtA2uk_W.mjs");
const Route$6 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "The hybrid marketplace connecting African capital with European secondary markets. Real-time bidding, escrow payments, and verified vendors."
    }, {
      property: "og:title",
      content: "Kilimanjaro — Cross-border auction marketplace"
    }, {
...
const $$splitComponentImporter$5 = () => import("./auth.register-bvFffZo4.mjs");
const Route$5 = createFileRoute("/auth/register")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./auth.login-BC4HGVNo.mjs");
const Route$4 = createFileRoute("/auth/login")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./auction._productId-BPyJBa9v.mjs");
const Route$3 = createFileRoute("/auction/$productId")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./admin.login-DVD4cNGL.mjs");
const Route$2 = createFileRoute("/admin/login")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin.dashboard-yngAb7vU.mjs");
const Route$1 = createFileRoute("/admin/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./admin.products.new-BNil9R8E.mjs");
